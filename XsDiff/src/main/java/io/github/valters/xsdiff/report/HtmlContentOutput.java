...
public class HtmlContentOutput implements DiffOutput {
    ...
    protected static final String HTML_TRANSFORMATION_XSL = "xslfilter/tagheader-xsdiff.xsl";
    ...
    /** invoke lambda function on self: {@code contentOutput.handler( content -> content.doSomething() );} */
